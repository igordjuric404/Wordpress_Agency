              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <Button
                    ...
                    variant="custom"
                    size="sm"
                    className={`${vBg} text-white w-14 h-14 !p-0 flex items-center justify-center hover:!bg-white group overflow-visible transition-colors duration-300 ease-in-out`}
                  >
                    <social.icon size={iconSize} strokeWidth={2.5} className={`${hoverIconColor} transition-colors duration-300 ease-in-out`} />
                  </Button>
                );
