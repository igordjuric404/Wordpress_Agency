...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'services.ai-integration.description': 'Customer support chatbots, automated workflows, and AI-powered content creation for marketing',
  ...
  sr: {
    ...
    'contact.schedule.description': 'Preferirajte li da razgovarate o vašem projektu pozivom?',
